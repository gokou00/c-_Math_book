...
int main(){
    Point X; //testing constructor version 1
    Point Y(3,4); // testing constructor version 2

    cout << "The point X is " << X << " and the point Y is " << Y << endl;
    cout << "Point Y in polar coordinates is (" << Y.getR() << "," << Y.getA() << ")" << endl;
    cout << "The distance between these points is "<< dist(X,Y) << endl;
    cout << "The midpoint between these point is "<< midpoint(X,Y) <<endl;
